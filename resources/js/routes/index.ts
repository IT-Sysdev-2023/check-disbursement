...
/**
* @see \App\Http\Controllers\CheckBorrowingController::checkBorrowing
 * @see app/Http/Controllers/CheckBorrowingController.php:25
 * @route '/section-head/check-borrowing/index'
 */
export const checkBorrowing = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: checkBorrowing.url(options),
    method: 'get',
})

checkBorrowing.definition = {
    methods: ["get","head"],
 ...
 * @route '/section-head/check-borrowing/index'
 */
checkBorrowing.url = (options?: RouteQueryOptions) => {
    return checkBorrowing.definition.url + queryParams(options)
}
 ...
 * @route '/section-head/check-borrowing/index'
 */
checkBorrowing.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: checkBorrowing.url(options),
    method: 'get',
})
/**
 ...
 * @route '/section-head/check-borrowing/index'
 */
checkBorrowing.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: checkBorrowing.url(options),
    method: 'head',
})
 ...
 * @route '/section-head/check-borrowing/index'
 */
    const checkBorrowingForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: checkBorrowing.url(options),
        method: 'get',
    })
 ...
 * @route '/section-head/check-borrowing/index'
 */
        checkBorrowingForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: checkBorrowing.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/section-head/check-borrowing/index'
 */
        checkBorrowingForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: checkBorrowing.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    checkBorrowing.form = checkBorrowingForm
/**
* @see \App\Http\Controllers\CheckBorrowingController::secondaryBorrowCheck
 * @see app/Http/Controllers/CheckBorrowingController.php:49
 * @route '/section-head/check-borrowing/secondary-borrow'
 */
export const secondaryBorrowCheck = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: secondaryBorrowCheck.url(options),
    method: 'put',
})

secondaryBorrowCheck.definition = {
    methods: ["put"],
 ...
 * @route '/section-head/check-borrowing/secondary-borrow'
 */
secondaryBorrowCheck.url = (options?: RouteQueryOptions) => {
    return secondaryBorrowCheck.definition.url + queryParams(options)
}
 ...
 * @route '/section-head/check-borrowing/secondary-borrow'
 */
secondaryBorrowCheck.put = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: secondaryBorrowCheck.url(options),
    method: 'put',
})
 ...
 * @route '/section-head/check-borrowing/secondary-borrow'
 */
    const secondaryBorrowCheckForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: secondaryBorrowCheck.url({
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/section-head/check-borrowing/secondary-borrow'
 */
        secondaryBorrowCheckForm.put = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: secondaryBorrowCheck.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    secondaryBorrowCheck.form = secondaryBorrowCheckForm
/**
* @see \App\Http\Controllers\CheckBorrowingController::returnChecks
 * @see app/Http/Controllers/CheckBorrowingController.php:139
 * @route '/section-head/check-borrowing/return-check'
 */
export const returnChecks = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: returnChecks.url(options),
    method: 'put',
})

returnChecks.definition = {
    methods: ["put"],
 ...
 * @route '/section-head/check-borrowing/return-check'
 */
returnChecks.url = (options?: RouteQueryOptions) => {
    return returnChecks.definition.url + queryParams(options)
}
 ...
 * @route '/section-head/check-borrowing/return-check'
 */
returnChecks.put = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: returnChecks.url(options),
    method: 'put',
})
 ...
 * @route '/section-head/check-borrowing/return-check'
 */
    const returnChecksForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: returnChecks.url({
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/section-head/check-borrowing/return-check'
 */
        returnChecksForm.put = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: returnChecks.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    returnChecks.form = returnChecksForm
/**
