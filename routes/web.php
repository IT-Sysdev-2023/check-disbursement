...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:disbursement_officer|admin')->group(function () {
        ...
        Route::prefix('retrieved-checks')->group(function () {
            ...
            Route::get('clear-cache', [ScannedRecordsController::class, 'clearCache'])->name('clearCache');
            ...
            Route::put('update-assign-cheque-number', [AssignedCheckNumberController::class, 'updateChequeNumber'])->name('update-assign-cheque-number');
